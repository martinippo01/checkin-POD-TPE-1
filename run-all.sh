...
bash adminClient.sh -DserverAddress="$SERVER_ADDRESS" -Daction=addSector -Dsector=A
...
#1.2
bash adminClient.sh -DserverAddress="$SERVER_ADDRESS" -Daction=addCounters -Dsector=A -Dcounters=1
...
bash adminClient.sh -DserverAddress="$SERVER_ADDRESS" -Daction=addCounters -Dsector=D -Dcounters=2
bash adminClient.sh -DserverAddress="$SERVER_ADDRESS" -Daction=addCounters -Dsector=C -Dcounters=2
